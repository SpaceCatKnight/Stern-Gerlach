...
% stol=scalar tolerances on fractional improvement in sss,default stol=.0001
...
%  {}= optional parameters
% sss=scalar sum of squares=sum-over-i(wt(i)*(y(i)-f(i)))^2.
...
% Modified by Saskia Bosma 15-Jan-2010
%       1) Changed variable name ss to sss (conflicting with existing Matlab
%       function v7.9)
%
% Refrences:
