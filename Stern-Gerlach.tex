...
Die Magnetische Feldstärke haben wir anhand der Magnetfeld-Eichkurve (Abbildung \ref{Abb:Eichkurve} im Appendix) bestimmt. Die Formel \begin{equation} \label{Bi}
...
In Tabelle \ref{tabelle1} sind die wichtigsten Resultate der Messungen zusammengefasst, und zwar der Strom $I$ durch die Magnetspulen, die Magnetfeldstärke $B$, die der jeweiligen Stromstärke $I$ entspricht (bestimmt anhand der Formel \ref{Bi} der Magnetfeld-Eichkurve in der Versuchsanleitung), die abgelesene Temperatur $T$ des Ofens und der Grösse $q$. Wir beschränken uns
